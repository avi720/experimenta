...
export function useShoParameters(experiment) {
    ...
    const initializeParameters = useCallback(() => {
        ...
        console.log('[useShoParameters] Initialized parameters:', defaultParams);
        console.log('[useShoParameters] t_max value:', defaultParams.t_max);
