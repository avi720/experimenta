...
export function useFreeFallParameters(experiment) {
    const [parameters, setParameters] = useState({});
    const [selectedPreset, setSelectedPreset] = useState("");

    const initializeParameters = useCallback(() => {
        if (!experiment?.parameters) {
            console.warn('useFreeFallParameters: No parameters found in experiment', experiment);
            return;
        }
        ...
        console.log('useFreeFallParameters: Initialized parameters:', defaultParams);
